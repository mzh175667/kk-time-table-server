class CustomErrorHandler extends Error {
  ...
  static wrongCredentialsForDesignation(
    message = "Designtaion for this user is wrong"
  ) {
    return new CustomErrorHandler(401, message);
  }

  static notAccessable(
    message = "You are not able to access the admin pannel"
  ) {
    return new CustomErrorHandler(401, message);
  }
